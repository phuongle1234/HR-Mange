...
export class UpdateEmployeeDto {
  /**
   * Populated by AttachRouteIdInterceptor from the route `:id` param, not
   * sent by the client. Lets IsEmployeeCodeUnique/IsEmployeeEmailUnique
   * exclude the record being updated from the uniqueness check.
   */
  @IsOptional()
  @IsString()
  id?: string;
